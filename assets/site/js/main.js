...
$(window).on('load', function () { // makes sure the whole site is loaded 
    ...
    $('#loader_div').delay(400).fadeOut(); // will fade out the white DIV that covers the website. 
});
...
$(document).ready(function () {
    ...
    $(".dropdown-toggle").on("click", function () {
        ...
        if (($(".dropdown-menu").hasClass("on"))) {
            $("[name=idioma]").css("display", "block");
            // $(".dropdown-menu").css("hidemenu");
        } else {
            $("[name=idioma]").css("display", "none");
